...
export default function PostPreviewLarge({ post }: { post: Sanity.BlogPost }) {
	...
	return (
		...
		>
			<figure className="max-md:full-bleed relative rounded-3xl aspect-video overflow-hidden bg-ink/5 md:aspect-[1.5]">
				<Img
					className="aspect-[1.5] w-full object-cover rounded-3xl transition-[filter,transform] group-hover:scale-105 group-hover:brightness-110"
